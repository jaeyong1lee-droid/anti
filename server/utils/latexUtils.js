...
17. 🚨 [달러 기호 매칭 오류 및 이탈 방지 규칙]: 번호 매기기(예: "1) 연성 벽체...", "2) 고강성...")가 포함된 문단 내에서 공식들을 나열할 때, 각 공식들은 개별적으로 완벽히 수식 기호($ 또는 $$)로 열고 닫혀 있어야 합니다. 여는 수식 기호 없이 닫는 수식 기호만 배치하거나, 한글 제목이 수식 영역 안으로 빨려 들어가지 않도록 극도로 유의하십시오.
