...
특히 제시된 [출제 지침 기준 (Lockscreen Generation Standards)]을 최우선 지침으로 삼아 절대적으로 준수하십시오.
...
1. **🚨 [최우선 준수 사항: 동적 출제 지침 기준 극대화 반영]**:
   - 아래 **[출제 지침 기준 (Lockscreen Generation Standards)]**에 적혀 있는 지침 사항들을 **최우선 순위(우선순위 #1)로 삼아 타협 없이 엄격히 준수**하여 출제하십시오.
   - 만약 **[출제 지침 기준 (Lockscreen Generation Standards)]**에 적힌 내용이 본 프롬프트의 다른 일반적인 설명(예: 질문 구성 방식, 비율 등)과 상충되거나 더 강력한 제약을 거는 경우, **무조건 [출제 지침 기준 (Lockscreen Generation Standards)]을 100% 우선하여 적용**해야 합니다.
