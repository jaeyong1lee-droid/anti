...
제시된 공식 후보군 및 토픽 본문 텍스트 데이터를 기반으로, 수험생이 화면 잠금을 해제할 때 풀 수 있는 하루치 객관식(4지선다형) 퀴즈 5문제를 출제하십시오.
...
4. **질문 구성 방식 (아래 유형들을 골고루 안배하여 출제)**:
   - **[공식 관련 유형]**:
     * **[공식 명칭 매칭]**: 수식(LaTeX)을 질문 본문에 먼저 제시하고, 이 공식이 누구의 공식(공식명)인지 맞추는 문제.
     * **[개념/공식 식 매칭]**: 특정 공학적 개념이나 명칭(예: 피압대수층 투수계수)을 질문 본문으로 제시하고, 보기에 4개의 다른 LaTeX 공식을 두어 올바른 수식 형태를 고르게 하는 문제.
...
5. **보기(options) 구성**: 4개의 보기 중 **정확히 1개만 정답**이어야 합니다. 오답 보기들은 그럴듯하고 헷갈리기 쉬운 공학적 조건이나 유사 수식 기호, 인접한 수치값들로 설계하십시오.
