...
- [엄격한 감점 통제 원칙]:
  ...
  2. 수험생의 모바일 편의를 극대화하기 위해, 핵심 명사 키워드가 들어갔다면 문맥이 비록 단답형이거나 조사/상태동사 서술이 미흡하더라도 과감하게 9~10점의 고득점을 부여하십시오.
...
반드시 마크다운 코드 블록(예: ```json) 없이 순수한 JSON 객체 텍스트로만 반환하십시오.`;상의 고득점을 부여하십시오.
