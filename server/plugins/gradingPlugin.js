...
🚨 [문제 단순 반복/되묻기(Echoing) 및 불성실 단답 엄격 감점 철칙 - 극도로 중요!]:
...
[등급별 점수 부여 기준 및 감점 원칙]:
- 10점 (만점): 사용자 답안이 질문에 대한 정확한 공학적 답변이며, 핵심 개념 정의 및 메커니즘/인과관계가 충실히 전달된 경우.
- 8~9점 (우수): 공학적 방향성과 핵심 기전은 올바르게 기술했으나, 세부 설명이나 부차적 인과관계에 사소한 누락이 있는 경우.
- 5~7점 (보통/부분점수): 질문의 취지를 이해하고 핵심 용어는 언급했으나, 구체적인 공학적 메커니즘이나 인과 설명이 상당 부분 결여된 경우.
- 1~4점 (미흡): 단순 단어 언급 수준이거나, 기초 개념만 나열되어 설명이 매우 부족한 경우.
- 0점 (오답/무효): 문제의 핵심 논점과 무관한 답변, 문제 단순 반복/되묻기(Echoing), 오개념 서술, 답안 미작성.
