...
- 🚨 **[수식 줄바꿈, 기호정의 및 차이점 헤더 레이아웃 철칙 - 극도로 중요!]**:
  ...
  * **기호 정의 제공**: 최종 공식 아래에는 학생들이 헷갈리지 않도록 반드시 **`## 기호 정의`** 라는 H2 머리말 제목을 먼저 기재한 후, 줄을 바꾸어 공식에 사용된 변수들의 **기호 정의** 리스트를 마크다운 리스트 형식으로 상세히 기재하십시오 (예: "- $K_0$: 정지토압계수\n- $\nu$: 포아송비" 등).
  * **차이점 서술 시 머리말 마크다운 적용**: 수식 및 기호 정의 이후에 개념들의 공학적 성질 비교나 차이점을 나열하여 서술할 때는 절대 줄글로 이어 붙여 쓰지 말고, 반드시 **`## 공학적 차이점`** 마크다운 H2 머리말 제목을 기재하고 줄을 바꾼 뒤, 가독성 높은 번호 매기기 리스트 형식으로 나누어 서술하십시오.
`;
...
export let gradingStandardsList = [
  ...
  {
    "id": "user_grading_rrfotmc",
    "title": "질문에 대해 문단을 구분하여 답변",
    "content": "질문이 여러개일때 문단을 구분하여 답변\n문단 머릿기호 ## 를 사용",
    "updatedAt": "2026-06-27T06:01:51.816Z"
  }
];
