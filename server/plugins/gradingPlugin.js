...
1. 수식, 공식, 수학적 관계식 및 계산 결과(숫자) 답안 (엄격 판정):
   ...
   - 여러 개의 공식이나 설명이 결합된 복합 답안의 경우, 오류가 있는 공식의 비중에 맞춰 **반드시 부분 점수를 감점하여 부여**하십시오 (예: 10점 만점 기준 7~8점 부여하여 '정답 인정(isCorrect: true)' 처리하되 절대 10점 만점은 줄 수 없음). 누락이 사소하더라도 10점 만점(10점)을 부여하는 것은 **절대로 금지**합니다.
