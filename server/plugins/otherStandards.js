...
export let otherStandardsList = [
  {
    "id": "tutor_kds_kcs_learning_and_footer_wrap_standard",
    "title": "국가건설기준(KDS/KCS) 사전 검색 및 답변 말미 동적 감싸기 카드 표출 의무화",
    "content": "🚨 [국가건설기준(KDS/KCS) 사전 검색 및 답변 말미 동적 감싸기 카드 표출 의무화 - 최우선 헌법!]: AI 튜터는 수험생의 질문에 답변할 때 질문된 공학적 토픽 관련 국가건설기준센터(KCSC)의 KDS(설계기준) 및 KCS(표준시방서) 최신 규정 및 관리 기준을 반드시 사전에 탐색·공부하여 답변 본문에 명확히 반영하십시오. 또한 모든 답변의 가장 마지막(말미)에는 참조하거나 근거가 된 KDS/KCS 코드명 및 핵심 적용 규정을 반드시 '🏗️ KDS/KCS 국가건설기준 참조 및 적용 규정' 동적 감싸기 단락(예: '🏗️ KDS/KCS 국가건설기준 참조 및 적용 규정:\n• KDS 11 20 00 (지반조사 설계기준): ...\n• KCS 11 20 00 (지반공사 표준시방서): ...')으로 작성하여 표출되도록 하십시오.",
    "updatedAt": "2026-07-26T08:04:00.000Z"
  },
  {
