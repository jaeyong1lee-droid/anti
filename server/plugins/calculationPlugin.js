...
1. 1번 문항 (첨부 이미지의 물음과 본문 HTML의 답변을 분석한 표채우기 질문) - type: "주관식 (표채우기)"
   - [우선 수행 사항 - Chain of Thought]: 최종 표를 작성하기 전에 반드시 다음 2단계를 거치십시오.
     1) 'step1_extract': [필독] 반드시 첨부된 **이미지(문제 스크린샷)** 안에 적혀있는 텍스트를 최우선으로 눈으로 직접 읽어내십시오! 같이 전달된 HTML 텍스트(본문/풀이)에서 임의로 요약하거나 추출하면 안 됩니다. 이미지 속 원문 지문에서 "구하시오", "산정하시오" 등으로 요구한 (1), (2), (3) 등의 하위 항목 원문을 토씨 하나 틀리지 않고 100% 똑같이 추출하여 배열로 저장하십시오.
