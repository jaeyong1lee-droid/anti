...
1. 1번 문항 (첨부 이미지의 물음과 본문 HTML의 답변을 분석한 표채우기 질문) - type: "주관식 (표채우기)"
   ...
   - 🚨 **[절대 지침 - 창작 금지 및 1:1 추출]**: AI 임의로 실무 설계 대책이나 이론적 검토 항목(예: 불안정성 검토, 좌표계 변환 등)을 절대로 창작하지 마십시오.
...
[
  {
    ...
    "tableData": { "headers": ["구하는 항목", "계산 결과 및 답안"], "rows": [["(1) 분할된 세부 항목명 1", "[INPUT_1]"], ["(2) 분할된 세부 항목명 2", "[INPUT_2]"], ["...", "..."]] },
    "answers": { "INPUT_1": "정답 풀이 1" }
  }
]
`;
