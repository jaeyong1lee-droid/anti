...
1. 1번 문항 (첨부 이미지의 물음과 본문 HTML의 답변을 분석한 표채우기 질문) - type: "주관식 (표채우기)"
   ...
   - 'rows'의 첫 번째 열(구하는 항목)에는 앞서 추출한 'ocr_text'에서 찾아낸 명시적인 항목명(예: "(1) 침투수량", "(2) A, B 및 C점에서의 간극수압")을 글자 하나 바꾸지 말고 그대로(Verbatim) 넣으십시오. "(A)"나 "(1)"과 같이 번호만 덩그러니 쓰지 마십시오.
   - 'rows' 예시: [["(1) 침투수량", "[INPUT_1]"], ["(2) A, B 및 C점에서의 간극수압", "[INPUT_2]"]]
...
[
  {
    ...
    "ocr_text": "이미지에서 눈으로 읽어낸 (1), (2), (3) 문제 지문 원문 전체 텍스트",
    "tableData": { "headers": ["구하는 항목", "계산 결과 및 답안"], "rows": [["(1) 이미지에서 추출한 원문 그대로", "[INPUT_1]"], ["(2) 이미지에서 추출한 원문 그대로", "[INPUT_2]"]] },
