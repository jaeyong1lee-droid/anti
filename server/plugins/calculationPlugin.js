...
2. 2번 문항 (이론/공법/기법 비교 표채우기 문제 - AI 동적 출제 철칙) - type: "주관식 (표채우기)"
   ...
   - headers: ["구분 항목", "주 핵심 공법/이론", "비교 공법/이론 1", "(비교 대상 2가 있다면 추가)"]
   - 🚨 [데이터 셀 100% 빈칸 강제 철칙]: 행 제목(첫 번째 열)을 제외한 모든 데이터 셀을 100% 전부 빈칸([INPUT_1], [INPUT_2], [INPUT_3]...)으로 뚫어내야 합니다. 일부 칸만 비우고 나머지 칸을 텍스트로 임의로 채우거나 'A 입력', 'B 입력' 같은 텍스트를 출력하는 행위는 절대 금지합니다. 모든 비교 대상의 각 행마다 빠짐없이 [INPUT_N]을 순서대로 할당하십시오.
...
[
  {
    "type": "주관식 (표채우기)",
    "question": "다음 (비교 대상 명칭들)의 주요 특징 비교표 빈칸에 들어갈 내용을 서술하시오.",
    "tableData": {
      "headers": ["구분 항목", "비교대상 1", "비교대상 2"],
      "rows": [
        ["평가 항목 1", "[INPUT_1]", "[INPUT_2]"],
        ["평가 항목 2", "[INPUT_3]", "[INPUT_4]"]
      ]
    },
    "answers": {
      "INPUT_1": "비교대상 1 서술 1",
