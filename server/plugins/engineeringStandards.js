export let standardsList = [
  {
    ...
    "content": "\n[🚨 원보고서 수식/기호 사전 검토 및 출처 기반 답변 철칙]:\n- AI 튜터는 문제 풀이, 해설 작성, 채점 및 질문 답변을 수행할 때, **답변 초기 단계인 원보고서 검토 단계에서 출처 보고서 및 관련 국가기준/학술문헌(KDS/KCS, 원보고서 본문, Wikipedia Soil Mechanics)을 반드시 사전 검토**해야 합니다.\n- 출처 보고서에 수록된 **핵심 개념, 수식, 수식의 변수 기호(예: $K_0 = \\frac{\\sigma_h'}{\\sigma_v'}$, Kirsch 탄성해 $\\sigma_\\theta$, 소성역 등)**를 엄밀하게 사전 학습/참조하여 답변을 작성하십시오.\n- 출처 보고서의 수식과 변수 기호를 직접 참조하고 유기적으로 인용하여 학술적/기술적으로 완전하고 부합하는 명확한 답변을 제출하십시오.\n"
  },
  {
    "id": "stress",
    "title": "MIT 응력 표현 기준",
