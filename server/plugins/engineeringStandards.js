export let standardsList = [
  {
    ...
    "content": "\n[🚨 원보고서/KDS 출처 사전 검토 및 출처 기반 문제 출제/답변 철칙 — 극도로 중요!]:\n- AI는 문제를 출제하거나 해설, 모범답안 및 AI 튜터 답변을 작성할 때, **문제 생성 및 답변 초기 단계에서 출처 보고서 및 관련 국가기준/학술문헌(KDS/KCS, 원보고서 본문, Wikipedia Soil Mechanics)을 반드시 사전 검토**해야 합니다.\n- 출처 보고서에 수록된 공학적 현상 조건과 메커니즘(예: 저측압 $K_0 < 1.0$ 시 천장부 침하, 고측압 $K_0 > 1.0$ 시 측벽 압출 및 인버트 힐빙 등)을 출제 단계에서 사전에 100% 검증하고 일치시켜 출제하십시오.\n- 수험생이 화면의 출처 버튼('📜 출처 및 근거 보고서')을 확인했을 때 문제의 전제 조건과 출처의 공학적 지침이 100% 완벽하게 부합하도록 모순 없는 정확한 문제를 구성하십시오.\n"
  },
  {
    "id": "stress",
    "title": "MIT 응력 표현 기준",
