...
export let generationStandardsList = [
  ...
  },
  {
    ...
    "content": "🚨 [공식 암기 팁(memorizationTip) 생성 의무화 - 중요!]: 공식을 묻거나 설명하는 퀴즈/문제 데이터를 생성할 때, 핵심 개념과 대표 공식 외에도 수험생이 공식을 쉽게 연상하여 외울 수 있도록 돕는 연상법이나 암기 팁이 담긴 'memorizationTip' 필드를 반드시 문항 객체 내에 한글로 생성하십시오. (예: \"💡 **암기 팁**: ... 연상법: \\\"알제이(RQD/Jn)가 제이아(Jr/Ja)를 만나...\\\"\" 와 같이 직관적이고 기억에 남는 문구로 작성)",
