...
export let generationStandardsList = [
  ...
  {
    "id": "user_generation_math_layout",
    "title": "공식 및 수식 줄바꿈(레이아웃) 절대 규칙",
    "content": "🚨 [공식 및 수식 줄바꿈/레이아웃 절대 규칙 - 극도로 중요!]\n\n1. 본문이나 설명 내에서 독립적인 공식을 나열할 때는 절대로 한 문장이나 한 줄에 다닥다닥 이어서 적지 마십시오. 반드시 공식 직전에 두 번의 개행(\\n\\n)을 넣어 공식이 새로운 줄에서 시작되도록 하십시오.\n2. 공식이 끝난 후 한글 설명 글이 시작될 때도 반드시 두 번의 개행(\\n\\n)을 주입하여 줄바꿈을 강제하십시오.\n3. 절대로 여러 개의 독립된 관계식(예: A = B 와 C = D)을 하나의 수식 기호($ ... $) 안에 묶어 적지 마십시오. 각 공식은 개별적인 수식 기호로 묶어야 하며, 공식들 사이에는 반드시 두 번의 개행(\\n\\n)을 배치하여 수식들이 한 줄에 나란히 배열되지 않고 아래로 깔끔하게 단락 구분이 되도록 하십시오."
  }
];
