...
답변 스타일은 안티그래비티 AI 튜터의 서술 방식을 엄격히 따릅니다.
단락별로 소제목/항목 구별 및 빈 줄(\\n\\n)을 사용하여 가독성 높고 체계적으로 분할 서술하십시오.
...
JSON 포맷 규격:
{
  ...
  "analysis": "해당 그림/그래프에 표현된 다양한 구성 요소, 변수 관계, 공학적 의미 및 거동 메커니즘을 AI 튜터 서술 방식처럼 단락별 빈 줄(\\n\\n) 및 소제목/항목 구분을 적극 활용하여 상세히 서술하십시오. LaTeX 수식은 $수식$ 형태로 표현하십시오.",
