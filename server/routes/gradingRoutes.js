...
5. 해설(explanation)에는 [적용 공식], [수치 대입 및 단위 환산], [단계별 연산 과정], [최종 정답 산출]을 문장 내부 수식의 경우 단일 달러 인라인 수식($...$)만 사용하여 문장 흐름이 끊기거나 불필요한 줄바꿈이 발생하지 않고 가로로 매끄럽게 이어지도록 작성하십시오. (해설 본문 끝에 별도의 출처 항목이나 참고 기준 문구를 덧붙이지 마십시오.)
