...
- "structure": 🚨 **[필수사항]** 개요 설명 및 공식에 등장하는 모든 기호(예: $K_a$, $\\phi$, $\\delta$ 등)의 정의를 마크다운 리스트 형태로 반드시 작성하십시오. 기호가 전혀 없는 경우에는 빈 문자열("")로 작성하십시오. (예: "- $K_a$: 주동토압계수, - $\\phi$: 흙의 내부마찰각")
...
- "structure": 🚨 **[필수사항]** 위 formula에서 사용된 모든 기호의 정의를 장황하지 않게 최소한의 명사형 위주로 반드시 작성하십시오. (예: "- $t$: 숏크리트 두께 - $P$: 지반압")
