...
---------------------------------------------------------
[문제 생성 태스크 시작]:
위의 절대 지침과 기준 법규를 완전히 숙지한 상태에서, 아래 제공되는 [토픽 핵심 주제], [핵심 키워드], [첨부파일 본문 텍스트]를 심층 분석하여, 총 **정확히 7개**의 예상문제(주관식 개요 1개, 주관식 공식 1개, 주관식 표채우기(흐름도) 1개, 주관식 그래프해석 1개, 주관식 단답형 3개)를 생성해 주십시오.
...
[출제 요구사항]:
반드시 총 7개의 문제를 다음과 같이 구성하여 출제하십시오:
