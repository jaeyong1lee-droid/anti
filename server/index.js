...
app.post('/api/grading-standards', async (req, res) => {
  try {
    ...
    try {
      const standardsFilePath = path.join(__dirname, 'plugins', 'gradingStandards.js');
      const newContent = `// This file is auto-generated by the system. Do not edit manually.
export const gradingStandardsList = \${JSON.stringify(standards, null, 2)};
...
`;
      const resolvedContent = newContent.replace('\${JSON.stringify(standards, null, 2)}', JSON.stringify(standards, null, 2));
      await fs.promises.writeFile(standardsFilePath, resolvedContent, 'utf-8');
      console.log('Successfully wrote grading standards to local file.');
    } catch (fsErr) {
      if (fsErr.code === 'EROFS') {
        console.log('Read-only file system detected (Vercel). Bypassed local file write.');
      } else {
...
app.post('/api/validation-standards', async (req, res) => {
  try {
    ...
    // 3. Try to save to file system (local environment only)
    try {
      const standardsFilePath = path.join(__dirname, 'plugins', 'validationStandards.js');
      const newContent = `// This file is auto-generated by the system. Do not edit manually.
...
`;
      const resolvedContent = newContent.replace('\${JSON.stringify(standards, null, 2)}', JSON.stringify(standards, null, 2));
      await fs.promises.writeFile(standardsFilePath, resolvedContent, 'utf-8');
      console.log('Successfully wrote validation standards to local file.');
    } catch (fsErr) {
      if (fsErr.code === 'EROFS') {
        console.log('Read-only file system detected (Vercel). Bypassed local file write.');
      } else {
