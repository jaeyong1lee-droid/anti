...
1. 반드시 총 10개의 문제를 다음과 같이 구성하여 출제하십시오:
   - 1번 문제: 해당 토픽의 정의와 핵심 학술적 메커니즘을 테스트하는 개념 문제 (능동 인출용 서술식). "type" 값은 반드시 "개념 문제 (10점)"이어야 합니다.
   - 2번 문제: 해당 토픽의 수식, 물리/수학적 지표 연산식, 혹은 아키텍처/공법 개념도(Diagram) 핵심 구성요소를 작성하는 공식 문제 (능동 인출용 서술식). "type" 값은 반드시 "공식 문제 (25점)"이어야 합니다.
   - 3번 ~ 10번 문제 (총 8개 문제): 본문 교재의 상세 사실, 응용 역학 및 학술 지식을 세부적으로 검증하는 4지선다형 객관식 문제. "type" 값은 반드시 "객관식 (4지선다)"이어야 합니다.
