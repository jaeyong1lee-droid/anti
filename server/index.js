...
{
  "title": "개선된 이론/공식의 명칭",
  "answer": "기초 가정 및 물리적 모델 상태 설명부터 시작하여, 각 변수의 평형 방정식, 적분/미분 수학적 대입 및 이항, 최종 유도 공식에 이르는 전체 수식 유도 단계를 처음부터 끝까지 생략 없이 서술. (수식은 KaTeX 기호 $...$ 또는 $$...$$로 작성하고 줄바꿈과 단락을 일목요연하고 깊이 있게 구성)"
}
