...
1. 반드시 총 10개의 문제를 다음과 같이 구성하여 출제하십시오:
   ...
   [1번 문제] 주관식 (개요):
   - 목적: 토픽의 가장 핵심적인 정의, 역학적 거동 및 원리, 그리고 지지/저항 방식의 공학적 메커니즘을 종합적이고 명료하게 묻는 고품격 기술사형 질문.
   - "type" 값: 반드시 "주관식 (개요)"
   - "question": 토픽의 핵심 정의, 대표적인 역학적 거동 특징, 그리고 지지력(또는 거동 저항) 확보 메커니즘과 타 공법과의 핵심 차이점을 종합 연계하여 묻는 고품격 완성형 질문. (예: "[토픽]의 핵심 역학적 거동 특성과 지지력 확보 방식, 그리고 공학적 핵심 차이점을 비교 서술하시오.")
   - "concept": 질문에서 요구한 세 가지 핵심 요소(1. 역학적 거동, 2. 지지력 확보 방식, 3. 핵심 공학적 차이점 또는 특징)에 대하여 줄바꿈(\\n)과 불릿 기호(•)를 사용해 각각 1줄씩 매우 컴팩트하고 명확하게 답변하십시오. 절대 장황한 설명조의 문장을 배제하고 핵심 공학 원리를 정확히 타겟팅하여 일대일 대응으로 작성하십시오.
   - "formula": 반드시 빈 문자열 ""
   - "structure": 반드시 빈 문자열 ""
