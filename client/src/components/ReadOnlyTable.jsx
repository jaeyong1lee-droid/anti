          ...
          <tr className="bg-slate-900/80 text-slate-355 border-b border-slate-800">
            {headers.map((header, hIdx) => {
              ...
              return (
                <th 
                  key={hIdx} 
                  className={`relative p-1.5 sm:p-2 font-extrabold border-r border-slate-800 last:border-r-0 whitespace-normal break-words break-all overflow-hidden select-text ${
                ...
                {row.map((cell, cIdx) => {
                  ...
                  return (
                    <td 
                      key={cIdx} 
                      colSpan={cellColSpan}
                      className={`p-1.5 sm:p-2 border-r border-slate-800 last:border-r-0 text-slate-300 text-[14px] sm:text-[16px] whitespace-pre-line break-words break-all overflow-hidden select-text ${
