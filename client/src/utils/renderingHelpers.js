...
export function transformAsciiGraphToSvg(code) {
  ...
  return `<div class="w-full my-3 border border-amber-500/30 rounded-xl p-3 sm:p-4 bg-gradient-to-b from-slate-900 via-slate-950 to-slate-900 shadow-md select-text"><div class="flex items-center justify-between border-b border-slate-800/80 pb-2 mb-3"><div class="flex items-center gap-2"><span class="text-amber-400 font-bold text-sm sm:text-base">📈</span><span class="text-slate-100 font-bold text-xs sm:text-sm truncate">${title}</span></div><span class="px-2 py-0.5 text-[10px] sm:text-xs font-bold text-amber-300 bg-amber-500/15 border border-amber-500/30 rounded-md shrink-0">SVG 역해석 추세선</span></div><div class="w-full overflow-hidden py-1"><svg width="100%" height="160" viewBox="0 0 600 160" class="w-full h-auto min-h-[140px]"><line x1="45" y1="12" x2="45" y2="135" stroke="#475569" stroke-width="1.5"/><line x1="45" y1="135" x2="570" y2="135" stroke="#475569" stroke-width="1.5"/><path d="M 41 17 L 45 10 L 49 17" fill="none" stroke="#475569" stroke-width="1.5"/><path d="M 563 131 L 573 135 L 563 139" fill="none" stroke="#475569" stroke-width="1.5"/><line x1="45" y1="52" x2="570" y2="52" stroke="#1e293b" stroke-width="1" stroke-dasharray="3,3"/><line x1="45" y1="92" x2="570" y2="92" stroke="#1e293b" stroke-width="1" stroke-dasharray="3,3"/><line x1="215" y1="12" x2="215" y2="135" stroke="#1e293b" stroke-width="1" stroke-dasharray="3,3"/><line x1="390" y1="12" x2="390" y2="135" stroke="#1e293b" stroke-width="1" stroke-dasharray="3,3"/><path d="M 52 128 Q 230 65 545 25" fill="none" stroke="#f59e0b" stroke-width="2.5"/><circle cx="52" cy="128" r="4.5" fill="#fbbf24"/><circle cx="190" cy="78" r="4.5" fill="#fbbf24"/><circle cx="360" cy="48" r="4.5" fill="#fbbf24"/><circle cx="545" cy="25" r="4.5" fill="#fbbf24"/><foreignObject x="5" y="0" width="70" height="35"><div xmlns="http://www.w3.org/1999/xhtml" class="text-amber-400 font-bold text-xs sm:text-sm">${renderedY}</div></foreignObject><foreignObject x="430" y="136" width="165" height="24"><div xmlns="http://www.w3.org/1999/xhtml" class="text-slate-300 font-semibold text-[11px] sm:text-xs flex items-center justify-end gap-1">${renderedX} <span class="text-slate-400 text-[10px] sm:text-xs font-normal">(시간 t)</span></div></foreignObject><foreignObject x="130" y="42" width="180" height="32"><div xmlns="http://www.w3.org/1999/xhtml" class="px-2 py-0.5 bg-slate-950/95 border border-amber-500/60 rounded-md shadow-lg text-amber-300 font-bold text-[11px] sm:text-xs flex items-center justify-center gap-1 whitespace-nowrap"><span class="text-amber-400 shrink-0">기울기 =</span><span>${renderedSlope}</span></div></foreignObject></svg></div></div>`;
}
