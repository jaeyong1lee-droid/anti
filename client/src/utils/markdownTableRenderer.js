...
function renderTableToHtml(tableLines, precedingTitle = "", hideWrapper = false, hideRemarks = false) {
  ...
  html += `</button>`;
  html += `<button onclick="window.__toggleDiagramCard &amp;&amp; window.__toggleDiagramCard(this)" class="text-xs font-bold bg-slate-800/90 hover:bg-slate-700 text-slate-300 border border-slate-700/80 px-2.5 py-1 rounded-lg transition-all flex items-center gap-1 cursor-pointer select-none">`;
