...
console.log("Change 0:", processed);
...
console.log("Change 1:", processed);

  text = text.replace(/₩/g, '\\')
console.log("Change 2:", processed);
...
console.log("Change 7:", processed);
                       .replace(/W유m?/gi, '\\mu m');
...
console.log("Change 8:", processed);
...
console.log("Change 9:", processed);
...
console.log("Change 10:", processed);
...
console.log("Change 14:", processed);
...
console.log("Change 15:", processed);
...
console.log("Change 16:", processed);
...
console.log("Change 23:", processed);
                       .replace(/\x0a\s*e\b/g, '\\ne')
                       .replace(/\x0a\s*u\b/g, '\\nu')
...
console.log("Change 24:", processed);
...
console.log("Change 25:", processed);
  ...
  processed = processed.replace(/(?<=:[^\n]*)\s+([–—−-]\s*(?:\$[^\$]+\$|[a-zA-Z0-9_\\\{\}]+)\s*:)/g, '\n$1');
console.log("Change 26:", processed);
...
console.log("Change 29:", processed);
  processed = processed.replace(/(\\quad\s*\\text\{[a-zA-Z]+\}|\b[a-zA-Z]+\b|\b\\text\{[a-zA-Z]+\})\s*\$(\s*_[a-zA-Z0-9])/g, '$$ $1$2');
console.log("Change 30:", processed);
...
console.log("Change 31:", processed);
    if (string[offset - 1] === '\\') {
      return match;
    }
...
console.log("Change 32:", processed);
...
console.log("Change 33:", processed);
