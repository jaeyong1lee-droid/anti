    ...
    <div className="min-h-screen bg-slateCustom-950 pb-16 flex flex-col justify-start">
      ...
      {selectedTopic && (
        <div className="fixed inset-y-0 right-0 left-0 z-50 bg-black/80 backdrop-blur-sm flex flex-col md:pl-28 pc-enlarged-text">
          {/* Review Header */}
          <div className="relative flex flex-col md:flex-row md:items-center justify-between px-5 py-4 bg-slateCustom-950 border-b border-violet-500/20 flex-shrink-0 gap-4">
            <div className="flex items-start gap-3 min-w-0 w-full md:w-auto pr-8 md:pr-0">
              ...
              <div className="min-w-0 flex-grow">
                ...
                <div className="flex flex-col gap-1.5 mt-1">
                  ...
                  {(selectedTopic.pdf_name || (selectedTopic?.schedule_id && selectedTopic?.schedule_id !== 9999)) && (
            ...
            <button
              ...
              className="md:hidden absolute top-4 right-4 text-slate-400 hover:text-white p-1 cursor-pointer active:scale-95 transition-all duration-150"
              title="닫기"
            >
              <X size={20} />
            </button>
