...
export default function App() {
  ...
  const normalizeAndCompactifyFormulas = (formulas) => {
    ...
    return formulas.map(f => {
      ...
      const compactTitles = {
        "Barton의 암반 Q분류": "Barton(바톤)의 암반 Q분류",
        "Terzaghi 얕은기초 극한 지지력": "Terzaghi(테르자기)의 극한 지지력",
        "연약지반 Sand Mat 최소 소요 두께": "연약지반 Sand Mat 최소 두께",
        "평사투영 극점 변환 반경 (등면적 투영)": "평사투영 Schmidt Net 극점 반경",
        "락볼트 인발시험 설계 지반 고착력": "락볼트(Rock Bolt) 설계 지반 고착력",
        "Rankine 주동토압": "랭킹(Rankine)의 주동토압 계수",
        "Terzaghi 1차원 압밀 지배 미분방정식": "Terzaghi(테르자기)의 1차원 압밀",
        "보상도 (보상기초 하중 상쇄 비율)": "보상기초(Compensated Foundation) 보상도(C)",
        "터널 배면 싱글쉘 정수압 분포 공식": "터널 싱글쉘(Single Shell) 설계 수압",
        "가설 흙막이 벽체 지반스프링상수": "가설 흙막이 수평 지반반력계수"
      };
  ...
  const handleOpenFormulaExam = async () => {
    ...
    const defaultFormulas = [
      ...
      },
      {
        ...
        question: "Terzaghi(테르자기)의 극한 지지력",
      ...
      },
      {
        ...
        question: "평사투영 Schmidt Net 극점 반경",
      ...
      },
      {
        ...
        question: "락볼트(Rock Bolt) 설계 지반 고착력",
      ...
      },
      {
        ...
        question: "Terzaghi(테르자기)의 1차원 압밀",
      ...
      },
      {
        ...
        question: "보상기초(Compensated Foundation) 보상도(C)",
      ...
      },
      {
        ...
        question: "터널 싱글쉘(Single Shell) 설계 수압",
