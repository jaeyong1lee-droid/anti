const fs = require('fs');
// Load the text from a variable
const text = `동을 직관적으로 증명하기 위해 필수적으로 암기하고 그려야 하는 **랭킨(Rankine) 토압 이론에 따른 옹벽의 주동 및 수동 토압 분포 단면도**입니다.
...
fs.writeFileSync('test_input.txt', text);
