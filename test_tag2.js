const html = `<svg width="100%" viewBox="0 0 800 450" style="background-color: #1e1e1e;" xmlns="http://www.w3.org/2000/svg">
<!-- 배경 그리드 및 영역 구분 →
...
let res = html.replace(/<([a-zA-Z가-힣][^>]*)>/g, (match, content) => {
